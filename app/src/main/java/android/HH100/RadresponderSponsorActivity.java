...
//onPageFinished1
//FindAccessToken
public class RadresponderSponsorActivity extends Activity implements Serializable {
	/**
	...
	String sponsor ="";
	boolean check = false;
	String activityType = ""; //eventtype, login
			...
			try {
				...
				if(httpURLConnection.getResponseCode() == HttpURLConnection.HTTP_OK) {
					...
					if(activityType.equals("login")){
						intent = new Intent(RadresponderSponsorActivity.this, RadresponderSponsorListActivity.class);
					}else{
						intent = new Intent(RadresponderSponsorActivity.this, RadresponderEventTypeListActivity.class);
					}

					intent.putExtra("sponsor", rad);
