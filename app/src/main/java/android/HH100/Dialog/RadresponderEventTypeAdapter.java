 ...
 */
public class RadresponderEventTypeAdapter extends BaseAdapter {
   ...
   public RadresponderEventTypeAdapter(Context ctxt, ArrayList<RadresponderAdapter3.Radresponder> mData) {
		context = ctxt;
        list = mData;
    }
    ...
    private View.OnClickListener listClick = new View.OnClickListener()
    {
        ...
        public void onClick(View view) {
          ...
          // mListener.onCellClick( holder.idx, list.get(holder.idx).name, list.get(holder.idx).sponsor);
           mListener.onCellClick( holder.idx, list.get(holder.idx).name);
        }
    };
